    ...
    var setSearchGrid = {
        ...
        rowClick: function (evt, ui) {
            if (ui.rowData) {
                ...
                $("#Name").val(data.Name); $("#Code").val(data.Code); $("#Deactive").prop('checked', data.Deactive); $("#IsShowLnk").prop('checked', data.IsShowLnk); $("#Society").val(data.Society); $("#Street").val(data.Street); $("#Landmark").val(data.Landmark);
...
function ClearForm() {
    $("#ClientId").val(""); $("#Name").val(""); $("#Code").val(""); $("#Deactive").prop('checked', false); $("#IsShowLnk").prop('checked', false); $("#Society").val(""); $("#Street").val(""); $("#Landmark").val(""); $("#ddlCity").val(""); $("#Pincode").val("");
